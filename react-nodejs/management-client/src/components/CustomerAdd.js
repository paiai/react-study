        ...
        return(
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        <input type="file" className={classes.hidden} accept="image/*" id="raised-button-file" name="file" file={this.state.file} value={this.state.fileName} onChange={this.handleFileChange} />
                    ...
                    <DialogActions>
                        ...
                        <Button variant="outlined" color="primary" onClick={this.handleClose}>딛기</Button>
                    </DialogActions>
                </Dialog>
